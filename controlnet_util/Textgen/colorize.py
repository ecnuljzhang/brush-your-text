...
class Colorize(object):
    ...
    def color(self, text_arr, bg_arr, fg_col, bg_col, colorsRGB=None, colorsLAB=None, min_h=None, param=None):
        ...
        l_bg = Layer(alpha = 255 * np.ones_like(bg_arr, dtype = np.uint8), color = bg_col)
        ...
        l_bg = Layer(alpha = 255 * np.ones_like(bg_arr, dtype = np.uint8), color = bg_arr)
...
def colorize(surf, bg, fg_col, bg_col, colorsRGB=None, colorsLAB=None, min_h=None, param=None):
